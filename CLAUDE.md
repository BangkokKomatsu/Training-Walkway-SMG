...
| `nt_admin` | `rK7&HxX3PNf!` | Admin (NT) — ต้องเปลี่ยนรหัสผ่านตอน login ครั้งแรก |
| `sri_admin` | `f7K#MRq2tW9K` | Admin (SRI) — ต้องเปลี่ยนรหัสผ่านตอน login ครั้งแรก |
| `nbmt_admin` | `%uR*Cc99*D7J` | Admin (NBMT) — ต้องเปลี่ยนรหัสผ่านตอน login ครั้งแรก |
| `ext_admin` | `^T#3WDT^2GmJ` | Admin (EXT) — ต้องเปลี่ยนรหัสผ่านตอน login ครั้งแรก |
| `gsyi_admin` | `o3zSZ9!Gs9Zk` | Admin (GSYI) — ต้องเปลี่ยนรหัสผ่านตอน login ครั้งแรก |
| `kybt_admin` | `*LSZ6xEX9Nfs` | Admin (KYBT) — ต้องเปลี่ยนรหัสผ่านตอน login ครั้งแรก |
| `sgs_admin` | `A!96r3c*k5v*` | Admin (SGS) — ต้องเปลี่ยนรหัสผ่านตอน login ครั้งแรก |
| `snss_admin` | `oA%X7Nmf3f3#` | Admin (SNSS) — ต้องเปลี่ยนรหัสผ่านตอน login ครั้งแรก |
| `msft_admin` | `MVwv7GsV^i*8` | Admin (MSFT) — ต้องเปลี่ยนรหัสผ่านตอน login ครั้งแรก |
